...
function Yercaudguide() {
  ...
  return (
    <>
     ...
     <h1 style={{marginTop:'80px',textAlign:'center',color:'black'}}>Our Guide</h1>
     <div className='container'>
      <div className='row'>
       <Card style={{width:'250px'}} className='col-lg-4 m-5'>
        <Card.Body>
          <Card.Text>
           <Card.Img variant="top" src={kabil}alt='kabil' style={{width:'195px',height:'220px',borderRadius:'4px'}} />
            <div style={{width:'300px',height:'250px'}}><br></br>
                    <p>Name:kabil</p>
      ...
      <Card style={{width:'300px'}} className='col-lg-4 m-5'>
        <Card.Body>
          <Card.Text>
           <Card.Img variant="top" src={Harish}alt='harish' style={{width:'195px',height:'220px',borderRadius:'4px'}} />
      ...
      <Card style={{width:'300px'}} className='col-lg-4 m-5'>
        <Card.Body>
          <Card.Text>
          <Card.Img variant="top" src={Dinesh}alt='dinesh' style={{width:'195px',height:'220px',borderRadius:'4px'}} />
            <div style={{width:'300px',height:'250px'}}><br></br>
                    <p>Name:Dinesh</p>
      ...
      <div style={{textAlign:'center',paddingBottom:'20px'}}>
       <button onClick={() => navigate('/kodaikanal')} style={{height:'30px',width:'80px',borderRadius:'4px',backgroundColor:'black',color:'whitesmoke'}}>Back</button>
      </div> <hr></hr>
      <Footerhome/>
</>
  );
