...
function Yercaudguide() {
  ...
  return (
    <>
      ...
      <h1 style={{ marginTop: "80px", textAlign: "center", color: "black" }}>
        Our Guide
      </h1>
              ...
              <Card.Text>
                ...
                <div style={{ width: "300px", height: "250px" }}>
                  ...
                  <p>
                    ...
                    <img
                      src={fivestar}
                      alt="fivestar ratings"
                      style={{ height: "20px", width: "100px" }}
                    ></img>{" "}
                  </p>
                  <button
                    className="guide"
                    style={{ borderRadius: "5px", backgroundColor: "#BDCDCE" }}
                  >
                    {" "}
                    Book Now
                  </button>
