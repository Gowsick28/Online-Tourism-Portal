...
function Kollihillsguide() {
  ...
  return (
    <>
     ...
     <h1 style={{marginTop:'80px',textAlign:'center',color:'black',paddingTop:'30px'}}>Our Guide</h1>
     <div className='container'>
      ...
      <div style={{textAlign:'center',paddingBottom:'20px'}}>
       <button onClick={() => navigate('/kollihills')} style={{height:'30px',width:'80px',borderRadius:'4px',backgroundColor:'black',color:'whitesmoke'}}>Back</button>
      </div><hr></hr>
      <Footerhome/>
</>
  );
...
export default Kollihillsguide;
